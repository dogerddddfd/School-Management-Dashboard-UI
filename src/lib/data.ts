...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 8, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 9, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 10, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 11, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 13, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 14, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 0, 14, 45),
  },
  {
    title: "English",
    allDay: false,
...

  {
    ...
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 18, 45),
  },
  {
    title: "Math",
    allDay: false,
